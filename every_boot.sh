...
wget https://raw.githubusercontent.com/d0rsha/raspberry_kiosk/master/kiosk.sh
sudo mv -f kiosk.sh /home/pi/kiosk.sh

rm -f /lib/systemd/system/kiosk.service
wget https://raw.githubusercontent.com/d0rsha/raspberry_kiosk/master/kiosk.service
